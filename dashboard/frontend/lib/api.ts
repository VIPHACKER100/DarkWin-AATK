...
export const getCurrentScan = () =>
  request<{ scan_id: string | null; target: string | null; mode: string | null; status: string; phase: string | null; started_at: string | null; progress: number }>('/scan/current');

export const getScanHistory = () =>
  request<{ scan_id: string; target: string; mode: string; status: string; phase: string | null; started_at: string | null; progress: number }[]>('/scan/history');
